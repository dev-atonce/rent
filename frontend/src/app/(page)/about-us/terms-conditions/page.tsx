    ...
    return (
      <>
        ...
        <ol className="list-decimal list-inside">
          ...
          <li>
            หากผู้ให้เช่าพบว่าเครื่องจักรเสียหาย ซึ่งเกิดจากความผิดของผู้เช่า
            ผู้เช่าจะต้องรับผิดชอบค่าใช้จ่ายใดๆก็ตามที่เกิดขึ้น
            รวมถึงค่าขนส่งด้วย
          </li>
          <li>
            ผู้เช่าจะชำระค่าเช่าตามกำหนด ยกเว้นเหตุสุดวิสัยใดๆ
            ซึ่งบัญญัติไว้ตามกฎหมายเท่านั้น
          </li>
          <li>
            ค่าใช้จ่ายในการติดตั้งหรือประกอบเครื่องจักรที่ให้เช่า
            ถือเป็นความรับผิดชอบของผู้เช่า
          </li>
          <li>
            ชั่วโมงการทำงานมาตรฐานของเครื่องจักรให้เช่าอยู่ที่ 8 ชม.ต่อวัน 240
            ชม.ต่อเดือน
          ...
          <li>
            เมื่อมีการยืนยันในใบเสนอราคาเเล้ว
            ผู้เช่าตกลงและยอมรับกรณีที่ผู้ให้เช่าจัดหาพนักงานเพื่อควบคุมปฎิบัติงานทรัพย์สินของผู้เช่า
            ไม่ว่าจะเกิดเหตุผิดพลาดใดๆ ผู้ให้เช่าจะรับผิดชอบต่อค่าใช้จ่าย
            หรือค่าเสียหายใดๆเป็นจำนวนเงินไม่เกินร้อยละสิบของค่าเช่าทั้งหมด
            ผู้เช่าย่อมสามารถเรียกร้องค่าเสียหายได้
            หากผู้เช่าสามารถพิสูจน์ได้ว่าเป็นความผิดของผู้ให้เช่า
          </li>
    ...
    return (
      <div className="min-h-100 w-full">
        ...
        <p className="indent-10 mb-4">
          ...
          (หรือโดยการโอนเงินผ่านธนาคาร) เท่านั้น
          เมื่อลูกค้าได้รับใบเสนอราคาจากเจ้าหน้าที่ฝ่ายการตลาด
          และตกลงราคากันเป็นที่เเรียบร้อยแล้ว การส่งเครื่องจักร
          สำหรับลูกค้าเงินสด จะมีขั้นตอนดังนี้
        </p>
        <ol>
          <li>
            1).
            เจ้าหน้าที่ฝ่ายการตลาดได้รับออเดอร์และยืนยันการสั่งสินค้าจากทางลูกค้า
            (ลูกค้าเงินสด)
          </li>
          <li>
            2) เจ้าหน้าที่ฝ่ายการตลาดให้แผนกบัญชีทำใบสรุปยอดให้
            เพื่อส่งให้ลูกค้าชำระเงินก่อนรับสินค้า
          </li>
          <li>
            3) เมื่อลูกค้าส่งหลักฐานการชำระเงินเรียบร้อยแล้ว
            พนักงานบัญชีทำการตรวจสอบยอดเงิน
            และทำการส่งออเดอร์ให้พนักงานขนส่งดำเนินการต่อไป
          </li>
        </ol>
    ...
    return (
      <>
        ...
        <ul className="mt-4">
          ...
          <li>
            <p>2. สาขาบ่อวิน</p>
            <p className="indent-5">SRTC_SP 8942338177</p>
          </li>
          <li>
            <p>3. สาขาสมุทรปราการ</p>
          ...
          <li>
            <p>5. สาขามาบตาพุด</p>
            <p className="indent-5">SRTC_MP 6444955106</p>
          </li>
          <li>
            <p>6. สาขาสมุทรสาคร</p>
            <p className="indent-5">SRTC_SS 4351519146</p>
          </li>
        </ul>
        <div className="mt-2">
          <p className="text-red">
            โปรดตรวจสอบเลขที่บัญชี และชื่อบัญชีทุกครั้งก่อนทำรายการโอนเงิน
          </p>
          <p>
            ทางบริษัทฯ จะไม่รับผิดชอบใดๆหากท่านโอนเงินเข้าบัญชีบุคคลธรรมดา
            <span className="underline">
              กรุณาโอนเงินเข้าบัญชีของบริษัท เร้นท์ (ประเทศไทย) จำกัด เท่านั้น
            </span>
          </p>
        </div>
      </>
