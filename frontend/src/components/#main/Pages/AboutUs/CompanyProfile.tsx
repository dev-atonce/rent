...
export default function CompanyProfile({ lng }: any) {
  ...
  return (
    <>
      <div className="bg-slate-50 from-blue-100 rounded-xl mt-4 p-10 md:p-20 text-[#002B7F]">
        ...
        <div className="flex flex-col gap-4">
          <div className="grid gap-4 grid-cols-1 md:grid-cols-6 grid-rows-1 border border-slate-400 px-4 py-6 rounded-lg shadow-md">
            <div className="font-bold flex items-center gap-2 md:col-span-2 md:border-r border-slate-300">
              ...
              {t("component.profile.name-of-coporation")}
            </div>
            <div className="col-span-5 md:col-span-4">
              <h1 className="font-semibold">{text[lng].name}</h1>
            </div>
          </div>
          ...
          <div className="grid gap-4 grid-cols-1 md:grid-cols-6 grid-rows-1   border border-slate-400 px-4 py-6 rounded-lg shadow-md">
            <div className="font-bold flex items-center gap-2 md:col-span-2 md:border-r border-slate-300">
              <BsPinMap size={20} />
              {t("component.profile.head-office")}
            </div>
            <div className="col-span-5 md:col-span-4">
              {text[lng]["head-office"]}
            </div>
          </div>
          <div className="grid gap-4 grid-cols-1 md:grid-cols-6 grid-rows-1   border border-slate-400 px-4 py-6 rounded-lg shadow-md">
            <div className="font-bold flex items-center gap-2 md:col-span-2 md:border-r border-slate-300">
              <TbReportMoney size={20} />
              {t("component.profile.paid-in-capital")}
            </div>
            <div className="col-span-5 md:col-span-4">{text[lng]["paid"]}</div>
          </div>
          <div className="grid gap-4 grid-cols-1 md:grid-cols-6 grid-rows-1   border border-slate-400 px-4 py-6 rounded-lg shadow-md">
            <div className="font-bold flex items-center gap-2 md:col-span-2 md:border-r border-slate-300">
              <FaCalendarDays size={20} />
              {t("component.profile.established")}
            </div>
            <div className="col-span-5 md:col-span-4">
              {text[lng]["established"]}
            </div>
          </div>
          <div className="grid gap-4 grid-cols-1 md:grid-cols-6 grid-rows-1   border border-slate-400 px-4 py-6 rounded-lg shadow-md">
            <div className="font-bold flex items-center gap-2 md:col-span-2 md:border-r border-slate-300">
              <BsPersonFill size={20} />
              {t("component.profile.representative")}
            </div>
            <div className="col-span-5 md:col-span-4">
              {text[lng]["representative"]}
            </div>
          </div>
          <div className="grid gap-4 grid-cols-1 md:grid-cols-6 grid-rows-1   border border-slate-400 px-4 py-6 rounded-lg shadow-md">
            <div className="font-bold flex items-center gap-2 md:col-span-2 md:border-r border-slate-300">
              <FaPeopleGroup size={20} />
              {t("component.profile.no-employee")}
            </div>
            <div className="col-span-5 md:col-span-4">
              {text[lng]["employee"]}
            </div>
          ...
          <div className="grid gap-4 grid-cols-1 md:grid-cols-6 grid-rows-1   border border-slate-400 px-4 py-6 rounded-lg shadow-md">
            <div className="font-bold flex items-center gap-2 md:col-span-2 md:border-r border-slate-300">
              <LuShip size={20} />
              {t("component.profile.types-of-business")}
            </div>
            <div className="col-span-5 md:col-span-4">
