...
const menus = [
  ...
  { title: "Career", url: "/webpanel/career" },
  // {title:'Home',url:"/webpanel/home"},
];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        <a href="/" className="">
          <Image
            src={"/img/rent_logo_white.png"}
            alt="logo"
            width={300}
            height={100}
            className="aspect-[16/4] object-cover"
          />
        </a>
      </div>
      {/* <!-- SIDEBAR HEADER --> */}
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          {menus?.map((i: any, k: any) => (
                            <li key={k}>
                              <Link
                                href={i?.url}
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === i?.url && "text-white"
                                }`}
                              >
                                {i?.title}
                              </Link>
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/webpanel/forms/form-elements"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                          ...
                          <li>
                            <Link
                              href="/webpanel/forms/form-layout"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
