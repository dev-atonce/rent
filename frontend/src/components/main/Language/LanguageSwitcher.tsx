...
export default function LanguageSwitcher({ position, language }: any) {
  return (
    <div className="relative inline-block notranslate px-4">
      <button
      ...
      <div
        className={`absolute ${language.openLang ? `block` : `hidden`} mt-1 w-25 rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-20`}
