...
export default function About() {
  return (
    <div className="bg-slate-300 pb-14 pt-20 relative project">
      <div className="absolute top-0 right-0 bottom-0 left-0 ">
        ...
        />
        <div className="absolute top-0 right-0 bottom-0 left-0 bg-white/95"></div>
      </div>
      <div className="container mx-auto flex flex-col items-center gap-10 relative">
        <div className="flex flex-col items-center gap-4">
          <h1 className="text-xl font-semibold text-[#0DA1DB]">
