    ...
    <>
      <div>
        ...
        <div>
          <ul className="list-inside list-disc">
            ...
            <li>
              กรณีลูกค้ามีผู้เข้าอบรมไม่ถึง 3 ท่าน แต่ประสงค์จะเปิดคอร์สด่วน
      ...
      <div className="py-4">
        ...
        <div>
          ...
          <p>
            การอบรมการใช้งานเครน (ปั้นจั่น) ตามหลักสูตรที่กฏกระทรวงแรงงานกำหนด
            ได้แก่ ผู้บังคับปั้นจั่น ผู้ให้สัญญาณแก่ผู้บังคับปั้นจั่น
            ผู้ยึดเกาะวัสดุของปั้นจั่น ผู้ควบคุมการใช้ปั้นจั่น ( อบรม 4 ผู้ )
            โดยจะอบรมทั้งภาคทฤษฎีและภาคปฏิบัติ และมีการสอบในวันสุดท้ายของการอบรม
          </p>
          <p>
            ★
            สำหรับผู้ที่สอบผ่านจะได้รับใบรับรองและมีคุณสมบัติในการควบคุมเครนชนิดเคลื่อนที่ได้
          </p>
          <ul className="list-inside list-disc">
            <li>
              รถกระเช้า AWP รถบูมลิฟต์ เอ็กซ์ลิฟต์ สกายมาสเตอร์ (Aerial Work
